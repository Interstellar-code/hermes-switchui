...
CANONICAL_REPO="/Users/aurora/hermes-switchui"
FORBIDDEN_REPO="/Users/aurora/hermes-switchui"
...
pkg = json.loads(Path('/Users/aurora/hermes-switchui/package.json').read_text())
print(pkg.get('name', ''))
PY
)"

if [[ "$REPO_NAME" != "hermes-switchui" ]]; then
