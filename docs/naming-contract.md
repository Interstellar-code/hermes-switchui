...
Do not suggest Claude-specific runtime wrappers or profile paths for live Hermes Switch UI behavior.
...
- **Hermes Switch UI** and **Hermes Agent** in update/config/status UI

Avoid:
- person-specific product labels baked into UI
- Claude-branded wording in Hermes Switch UI surfaces

## Reviewer rule

Any PR or patch that introduces new Claude-branded naming into Hermes Switch UI should be treated as a regression unless it is:
