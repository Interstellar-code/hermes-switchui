  ...
  const steps = [
    {
      ...
      body: 'Install Tailscale on the machine running Hermes Switch UI, then sign in.',
    ...
    },
    {
      ...
      body: 'Hermes Switch UI can talk to any OpenAI-compatible backend on mobile too. Make sure both the workspace and backend stay reachable over Tailscale or your local network.',
    ...
    {
      title: 'Open Hermes Switch UI on your phone',
      body:
