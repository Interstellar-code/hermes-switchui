...
export const AGENT_AVATAR_SKIN_TONE_OPTIONS: Array<ColorOption> = [
...
export const AGENT_AVATAR_HAIR_STYLE_OPTIONS: Array<EnumOption<AgentAvatarHairStyle>> = [
...
export const AGENT_AVATAR_HAIR_COLOR_OPTIONS: Array<ColorOption> = [
...
export const AGENT_AVATAR_TOP_STYLE_OPTIONS: Array<EnumOption<AgentAvatarTopStyle>> = [
  { id: "tee", label: "Tee" },
  { id: "hoodie", label: "Hoodie" },
  { id: "jacket", label: "Jacket" },
];

export const AGENT_AVATAR_BOTTOM_STYLE_OPTIONS: Array<EnumOption<AgentAvatarBottomStyle>> = [
  { id: "pants", label: "Pants" },
  { id: "shorts", label: "Shorts" },
  { id: "cuffed", label: "Cuffed" },
];

export const AGENT_AVATAR_HAT_STYLE_OPTIONS: Array<EnumOption<AgentAvatarHatStyle>> = [
  { id: "none", label: "None" },
  { id: "cap", label: "Cap" },
  { id: "beanie", label: "Beanie" },
];

export const AGENT_AVATAR_CLOTHING_COLOR_OPTIONS: Array<ColorOption> = [
...
export const AGENT_AVATAR_SHOE_COLOR_OPTIONS: Array<ColorOption> = [
...
const pick = <T,>(values: ReadonlyArray<T>, index: number) => values[index % values.length];

const resolveColor = (value: unknown, options: Array<ColorOption>, fallback: string) => {
