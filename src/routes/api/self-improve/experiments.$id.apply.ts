...
import { applyExperiment } from '../../../server/self-improve-client'

export const Route = createFileRoute('/api/self-improve/experiments/$id/apply')({
  server: {
    handlers: {
      POST: async ({ request, params }) => {
        ...
        try {
          const result = await applyExperiment(id)
