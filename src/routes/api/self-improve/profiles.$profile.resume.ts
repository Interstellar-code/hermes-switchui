...
import { resumeProfile } from '../../../server/self-improve-client'

export const Route = createFileRoute('/api/self-improve/profiles/$profile/resume')({
  server: {
    handlers: {
      POST: async ({ request, params }) => {
        ...
        try {
          const result = await resumeProfile(profile)
