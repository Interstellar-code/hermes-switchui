...
import { revertExperiment } from '../../../server/self-improve-client'

export const Route = createFileRoute('/api/self-improve/experiments/$id/revert')({
  server: {
    handlers: {
      POST: async ({ request, params }) => {
        ...
        try {
          const result = await revertExperiment(id, reason)
