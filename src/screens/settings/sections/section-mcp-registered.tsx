...
import { getPluginsHub, rescanDashboardPlugins } from '@/lib/hermes-client'
...
export default function SectionMcpRegistered() {
  ...
  async function handleRescan() {
    try {
      await rescanDashboardPlugins()
      toast('Plugin rescan complete', { type: 'success' })
      await queryClient.invalidateQueries({ queryKey: ['plugins-hub'] })
    } catch {
    ...
    <div>
      <div className="section-head">
        <div>
          ...
          <div className="desc">
            Installed dashboard plugins and agent extensions.
          </div>
        </div>
        <div className="meta">
          Section · <b>mcp-registered</b>
        </div>
      </div>
