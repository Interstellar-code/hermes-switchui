...
const DEFAULT_GYM_ITEMS: Array<FurnitureSeed> = [
  ...
  { type: "treadmill", x: 1140, y: 55, facing: 90 },
  { type: "weight_bench", x: 1140, y: 175, facing: 90 },
  { type: "dumbbell_rack", x: 1140, y: 235, facing: 180 },
  { type: "rowing_machine", x: 1140, y: 315, facing: 90 },
  { type: "kettlebell_rack", x: 1140, y: 390, facing: 180 },
  { type: "exercise_bike", x: 1140, y: 455, facing: 90 },
  { type: "punching_bag", x: 1140, y: 535, facing: 0 },
  { type: "yoga_mat", x: 1140, y: 600, facing: 0, color: "#0f766e" },
  { type: "plant", x: 1235, y: 650 },
